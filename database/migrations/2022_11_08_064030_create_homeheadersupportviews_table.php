...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('homeheadersupportviews', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('header_5th');
            $table->string('details_5th');
            $table->string('image_5th');
    ...
    {
        Schema::dropIfExists('homeheadersupportviews');
    }
};
