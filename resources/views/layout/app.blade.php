    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="{{asset('assets/img/1648631826.svg')}}" style="background-color: #ddd;padding:5px;border-radius:5px" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="{{asset('assets/img/1648631826.svg')}}" style="background-color: #ddd;padding:5px;border-radius:5px" alt="Logo"></a>
            </div>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img style="width:50px;height:50px;border-radius:50%;" src="{{asset('assets/img/arif.jpg')}}" alt="User Avatar">
                        </a>
